...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | AIOVTUE")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'ODJBZ-AQJ67-JMNXW-HJPOU-BUWE2-DEBZN',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(106.6054076594869, 29.708682386288302, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("9/10/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问aiovtue‘s博客",
...
function share_() {
  ...
  try {
    ...
    navigator.clipboard.writeText('aiovtue的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  var grt = new Date("09/10/2024 00:00:00");	// 网站诞生时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
    ? `<img alt="Static Badge" src="https://img.shields.io/badge/build-%E4%BB%80%E4%B9%88%E6%97%B6%E5%80%99%E6%9A%B4%E5%AF%8C%E4%B8%AB-brightgreen?style=social&logoColor=F5D7D7&logoSize=auto&label=aiovtue&labelColor=F5D7D7&color=F5D7D7">
...
function setBg(s) {
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://pic.imgdb.cn/item/66e58ddcd9c307b7e932e966.jpg);
    --darkmode-bg: url(https://pic.imgdb.cn/item/66e58ddcd9c307b7e932e966.jpg);
    --mobileday-bg: url(https://pic.imgdb.cn/item/66e58ddcd9c307b7e932e966.jpg);
    --mobilenight-bg: url(https://pic.imgdb.cn/item/66e58ddcd9c307b7e932e966.jpg);
  }`;
}
